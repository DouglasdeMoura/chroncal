...
copy the `got:` hash into `flake.nix`, and rerun the build.

The release workflow updates the Homebrew tap, the Scoop bucket, and both AUR
packages after GoReleaser publishes assets; no manual packaging steps remain.
