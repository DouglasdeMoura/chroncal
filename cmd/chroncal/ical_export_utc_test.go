...
// builds date-range bounds in time.Local. On a non-UTC host they must be
// normalized to UTC before a lexical compare against the UTC-stored
...
// the requested window open 2026-04-01 (= 2026-04-01T03:00:00Z). It must
